...
ggplot(twoASVs, aes(x = var, y = value_use, color = symptomatic_use)) + 
  ...
  theme(axis.text.x = element_blank(), axis.ticks.x = element_blank(), 
        ...
        legend.title = element_text(size = 9)) + guides(color=guide_legend(title="symptomatic?")) +
...
ggplot(two_WIDE, aes(x = `time-of-detection`, y = `pre-detection`, color = `symptomatic?`)) +
  geom_jitter(alpha = 0.5, position = position_jitter(width = 0.01, height = 0.01, seed = SEED_INT)) +
  scale_color_manual(values = colors[1:2]) + scale_x_sqrt() + scale_y_sqrt()+
...
load("/Users/maureencarey/local_documents/work/crypto_microbiome/cryptosporidium_microbiome/results/rf_TOD_abx_2020_09_02.RData")
AUC_TOD_abx = rf[[3]]
rm(rf)
