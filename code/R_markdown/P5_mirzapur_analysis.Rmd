...
load("/Users/maureencarey/local_documents/work/crypto_microbiome/cryptosporidium_microbiome/results/P3output_p2_2020_09_02.RData")
load("/Users/maureencarey/local_documents/work/crypto_microbiome/cryptosporidium_microbiome/results/P3output_p3_2020_09_02.RData")
...
load("/Users/maureencarey/local_documents/work/crypto_microbiome/cryptosporidium_microbiome/results/P3output_p1_2020_09_02.RData") # load save_df1 and save_df2
...
# number of Megaspaheara ASVs
temp = as.data.frame(tax_table(ps_mirzapur_rare))
dim(temp[temp$Genus == 'Megasphaera',])
# temp2 = as.data.frame(tax_table(ps_rare))
# dim(temp2[temp2$Genus == 'Megasphaera',])
...
twoASVs_TOD = tax2 %>% filter(var == 'ASV10 (Megasphaera)')
...
tax2 = tax %>% 
  ...
  mutate(var = ifelse(is.na(Family),
                      ...
                      ifelse(is.na(Genus), paste0(paste0(paste0(paste0(as.character('ASV'),id),' ([f]'),Family),')'),
                             paste0(paste0(paste0(paste0(as.character('ASV'),id),' ('),Genus),')'))))
PD_twoASVs = tax2 %>% filter(var == 'ASV10 (Megasphaera)')
...
df_mir = melt(rbind(count_df_PD_mirpur %>% select(-symptomatic_use,-Collinsella,-`symptomatic?`) %>% 
